...
class TestSketch(unittest.TestCase):
    ...
    def test_verify_unsolvable_states_removed(self):
        self.instance_data_mock.initial_s_idxs = [0, 1, 2]  
        self.instance_data_mock.is_deadend.side_effect = lambda s_idx: s_idx == 2  
        self.instance_data_mock.is_goal.side_effect = lambda s_idx: s_idx == 1  
    

        sketch = Sketch(self.dlplan_policy_mock, width=1)
