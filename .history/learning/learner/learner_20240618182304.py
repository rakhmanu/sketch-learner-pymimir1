    ...
    if encoding_type == EncodingType.EXPLICIT:
        ...
        for instance_data in instance_datas:
            ...
            for state_id in instance_data.state_space.get_states():
                print("instance_data.initial_s_idxs:", instance_data.initial_s_idxs)
                print("state_id:", state_id)
                print("Length of initial_s_idxs:", len(instance_data.initial_s_idxs))
                if state_id >= len(instance_data.initial_s_idxs):
                    raise ValueError("state_id is out of range")

                instance_data = instance_data.initial_s_idxs[state_id]
