...
if __name__ == "__main__":
    ...
    parser.add_argument("--encoding_type", type=encoding_type, default=EncodingType.EXPLICIT, choices=["d2", "explicit"], help="The encoding type for the sketch learner.")
...
#python3 learning/main.py --domain_filepath learning/benchmarks/gripper/domain.pddl --problems_directory learning/benchmarks/gripper/instances --width 1 --workspace workspac